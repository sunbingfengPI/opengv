...
bp::object p2p( bpn::ndarray &v, bpn::ndarray &p, bpn::ndarray &R )
{
...
bp::object p3p_kneip( bpn::ndarray &v, bpn::ndarray &p )
{
...
bp::object p3p_gao( bpn::ndarray &v, bpn::ndarray &p )
{
  CentralAbsoluteAdapter adapter(v, p);
  return listFromTransformations(
...
bp::object gp3p( bpn::ndarray &v, bpn::ndarray &p )
{
  CentralAbsoluteAdapter adapter(v, p);
  return listFromTransformations(
...
bp::object epnp( bpn::ndarray &v, bpn::ndarray &p )
{
  CentralAbsoluteAdapter adapter(v, p);
...
bp::object gpnp( bpn::ndarray &v, bpn::ndarray &p )
{
  CentralAbsoluteAdapter adapter(v, p);
  return arrayFromTransformation(
...
bp::object upnp( bpn::ndarray &v, bpn::ndarray &p )
{
  CentralAbsoluteAdapter adapter(v, p);
  return listFromTransformations(
...
bp::object optimize_nonlinear( bpn::ndarray &v,
                               bpn::ndarray &p,
                               bpn::ndarray &t,
                               bpn::ndarray &R )
{
...
public:
  ...
  CentralRelativeAdapter(
      bpn::ndarray &bearingVectors1,
      bpn::ndarray &bearingVectors2 )
...
bp::object twopt( bpn::ndarray &b1, bpn::ndarray &b2, bpn::ndarray &R )
{
...
bp::object twopt_rotationOnly( bpn::ndarray &b1, bpn::ndarray &b2 )
{
...
bp::object rotationOnly( bpn::ndarray &b1, bpn::ndarray &b2 )
{
  CentralRelativeAdapter adapter(b1, b2);
  return arrayFromRotation(
...
bp::object fivept_nister( bpn::ndarray &b1, bpn::ndarray &b2 )
{
  CentralRelativeAdapter adapter(b1, b2);
...
bp::object fivept_kneip( bpn::ndarray &b1, bpn::ndarray &b2 )
{
  CentralRelativeAdapter adapter(b1, b2);
...
bp::object sevenpt( bpn::ndarray &b1, bpn::ndarray &b2 )
{
  CentralRelativeAdapter adapter(b1, b2);
  return listFromEssentials(
...
bp::object eightpt( bpn::ndarray &b1, bpn::ndarray &b2 )
{
  CentralRelativeAdapter adapter(b1, b2);
...
bp::object eigensolver( bpn::ndarray &b1, bpn::ndarray &b2, bpn::ndarray &R )
{
  CentralRelativeAdapter adapter(b1, b2, R);
  return arrayFromRotation(
...
bp::object sixpt( bpn::ndarray &b1, bpn::ndarray &b2 )
{
  CentralRelativeAdapter adapter(b1, b2);
  return listFromRotations(
...
bp::object optimize_nonlinear( bpn::ndarray &b1,
                               bpn::ndarray &b2,
                               bpn::ndarray &t12,
                               bpn::ndarray &R12 )
{
...
bp::object triangulate( bpn::ndarray &b1,
                        bpn::ndarray &b2,
                        bpn::ndarray &t12,
                        bpn::ndarray &R12 )
{
...
bp::object triangulate2( bpn::ndarray &b1,
                         bpn::ndarray &b2,
                         bpn::ndarray &t12,
                         bpn::ndarray &R12 )
{
